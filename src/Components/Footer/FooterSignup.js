...
const FooterSignup = () => {
  return (
    ...
    >
      <p className="font-roboto font-bold leading-normal text-[#090b2b] text-xl text-center px-8 pt-4">
      ...
      <form className="flex flex-row flex-wrap justify-center items-center">
        ...
        <Link to="/sign-in-page" onClick={() => ScrollToTop()}>
          <button
            ...
            // }}
            className="bg-[#090b2b] w-[150px] h-[75px] font-roboto font-bold text-[#fff] text-xl rounded-[20px] px-4 mx-4 mb-6 mt-4"
          >
            Log In
          </button>
        </Link>
