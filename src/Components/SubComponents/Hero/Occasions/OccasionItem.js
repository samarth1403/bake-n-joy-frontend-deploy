    ...
    <div className="px-6">
      ...
      >
        <div className="flex flex-row flex-wrap justify-between items-start m-2">
          <div>
            <p className="w-[60px] font-roboto font-bold leading-normal text-[#090b2b] text-xl mx-4 my-2">
              {occasion?.occasionName}
            </p>
            <hr className="w-[60px] h-px bg-gray-500 border-0 dark:bg-gray-500 mx-4 my-4" />
            <button onClick={()=>handleClick(occasion?.occasionName)} className="bg-[#090b2b] font-roboto font-bold leading-normal text-[#fff] text-center text-sm rounded-[10px] mx-4 px-4 py-2">
              Shop Now
            </button>
          </div>
          ...
          <img
            src={occasion?.image}
            alt="occasion cake"
            className="bg-[#090b2b] w-[80px] h-[80px] rounded-full m-2"
          />
        </div>
      </div>
    </div>
