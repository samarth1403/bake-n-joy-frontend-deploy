...
const SingleProductDetails = () => {
  ...
  const { gotProduct , isLoading } = useSelector((state) => {
    ...
    <div>
      ...
      {!isLoading && (
        <div className="flex flex-row flex-wrap justify-center items-start">
          ...
          >
            <p className="font-roboto font-bold min-[320px]:text-xl sm:text-3xl text-center min-[320px]:px-2 sm:mx-8 my-4 mt-6">
              {gotProduct?.title}
            </p>
            <div className="flex flex-row flex-wrap justify-between items-center my-2">
              <p className="font-roboto font-bold text-xl mx-8 my-2 ">
